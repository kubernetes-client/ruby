...
begin
  ...
  puts "Exception when calling AutoscalingV2beta1Api->delete_collection_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
> V1Status delete_namespaced_horizontal_pod_autoscaler(name, namespace, body, opts)
...
begin
  result = api_instance.delete_namespaced_horizontal_pod_autoscaler(name, namespace, body, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Exception when calling AutoscalingV2beta1Api->delete_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta1Api->get_api_resources: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta1Api->list_horizontal_pod_autoscaler_for_all_namespaces: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta1Api->list_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta1Api->patch_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta1Api->patch_namespaced_horizontal_pod_autoscaler_status: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta1Api->read_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta1Api->read_namespaced_horizontal_pod_autoscaler_status: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta1Api->replace_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta1Api->replace_namespaced_horizontal_pod_autoscaler_status: #{e}"
end
```
