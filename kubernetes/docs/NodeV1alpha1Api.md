...
> V1alpha1RuntimeClass create_runtime_class(body, opts)
...
api_instance = Kubernetes::NodeV1alpha1Api.new
body = Kubernetes::V1alpha1RuntimeClass.new # V1alpha1RuntimeClass | 
opts = {
...
begin
  ...
  puts "Exception when calling NodeV1alpha1Api->create_runtime_class: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NodeV1alpha1Api->delete_collection_runtime_class: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NodeV1alpha1Api->delete_runtime_class: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NodeV1alpha1Api->get_api_resources: #{e}"
end
```
...
> V1alpha1RuntimeClassList list_runtime_class(opts)
...
begin
  ...
  puts "Exception when calling NodeV1alpha1Api->list_runtime_class: #{e}"
end
```
...
> V1alpha1RuntimeClass patch_runtime_class(name, body, opts)
...
begin
  ...
  puts "Exception when calling NodeV1alpha1Api->patch_runtime_class: #{e}"
end
```
...
> V1alpha1RuntimeClass read_runtime_class(name, opts)
...
begin
  ...
  puts "Exception when calling NodeV1alpha1Api->read_runtime_class: #{e}"
end
```
...
> V1alpha1RuntimeClass replace_runtime_class(name, body, opts)
...
begin
  ...
  puts "Exception when calling NodeV1alpha1Api->replace_runtime_class: #{e}"
end
```
