...
> V1beta1CSIDriver create_csi_driver(body, opts)
...
body = Kubernetes::V1beta1CSIDriver.new # V1beta1CSIDriver | 
opts = {
...
begin
  ...
  puts "Exception when calling StorageV1beta1Api->create_csi_driver: #{e}"
end
```
...
> V1beta1CSINode create_csi_node(body, opts)
...
api_instance = Kubernetes::StorageV1beta1Api.new
body = Kubernetes::V1beta1CSINode.new # V1beta1CSINode | 
opts = {
  pretty: 'pretty_example', # String | If 'true', then the output is pretty printed.
  dry_run: 'dry_run_example', # String | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
  field_manager: 'field_manager_example' # String | fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
...
begin
  ...
  puts "Exception when calling StorageV1beta1Api->create_csi_node: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling StorageV1beta1Api->delete_collection_csi_driver: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling StorageV1beta1Api->delete_collection_csi_node: #{e}"
end
```
...
> V1Status delete_csi_driver(name, opts)
...
begin
  ...
  puts "Exception when calling StorageV1beta1Api->delete_csi_driver: #{e}"
end
```
...
> V1Status delete_csi_node(name, opts)
...
begin
  ...
  puts "Exception when calling StorageV1beta1Api->delete_csi_node: #{e}"
end
```
...
> V1beta1CSIDriverList list_csi_driver(opts)
...
begin
  ...
  puts "Exception when calling StorageV1beta1Api->list_csi_driver: #{e}"
end
```
...
> V1beta1CSINodeList list_csi_node(opts)
...
begin
  ...
  puts "Exception when calling StorageV1beta1Api->list_csi_node: #{e}"
end
```
...
> V1beta1CSIDriver patch_csi_driver(name, body, opts)
...
begin
  ...
  puts "Exception when calling StorageV1beta1Api->patch_csi_driver: #{e}"
end
```
...
> V1beta1CSINode patch_csi_node(name, body, opts)
...
begin
  ...
  puts "Exception when calling StorageV1beta1Api->patch_csi_node: #{e}"
end
```
...
> V1beta1CSIDriver read_csi_driver(name, opts)
...
begin
  ...
  puts "Exception when calling StorageV1beta1Api->read_csi_driver: #{e}"
end
```
...
> V1beta1CSINode read_csi_node(name, opts)
...
begin
  ...
  puts "Exception when calling StorageV1beta1Api->read_csi_node: #{e}"
end
```
...
> V1beta1CSIDriver replace_csi_driver(name, body, opts)
...
begin
  ...
  puts "Exception when calling StorageV1beta1Api->replace_csi_driver: #{e}"
end
```
...
> V1beta1CSINode replace_csi_node(name, body, opts)
...
begin
  ...
  puts "Exception when calling StorageV1beta1Api->replace_csi_node: #{e}"
end
```
