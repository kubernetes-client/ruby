...
> V2beta2HorizontalPodAutoscaler create_namespaced_horizontal_pod_autoscaler(namespacebody, opts)
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->create_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->delete_collection_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->delete_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->get_api_resources: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->list_horizontal_pod_autoscaler_for_all_namespaces: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->list_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->patch_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->patch_namespaced_horizontal_pod_autoscaler_status: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->read_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->read_namespaced_horizontal_pod_autoscaler_status: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->replace_namespaced_horizontal_pod_autoscaler: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling AutoscalingV2beta2Api->replace_namespaced_horizontal_pod_autoscaler_status: #{e}"
end
```
