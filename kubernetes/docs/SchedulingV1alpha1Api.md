...
body = Kubernetes::V1alpha1PriorityClass.new # V1alpha1PriorityClass | 
...
begin
  ...
  puts "Exception when calling SchedulingV1alpha1Api->create_priority_class: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling SchedulingV1alpha1Api->delete_collection_priority_class: #{e}"
end
```
...
> V1Status delete_priority_class(name, body, opts)
...
begin
  result = api_instance.delete_priority_class(name, body, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Exception when calling SchedulingV1alpha1Api->delete_priority_class: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling SchedulingV1alpha1Api->get_api_resources: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling SchedulingV1alpha1Api->list_priority_class: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling SchedulingV1alpha1Api->patch_priority_class: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling SchedulingV1alpha1Api->read_priority_class: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling SchedulingV1alpha1Api->replace_priority_class: #{e}"
end
```
