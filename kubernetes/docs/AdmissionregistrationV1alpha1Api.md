...
> V1alpha1ExternalAdmissionHookConfiguration create_external_admission_hook_configuration(body, opts)
...
body = Kubernetes::V1alpha1ExternalAdmissionHookConfiguration.new # V1alpha1ExternalAdmissionHookConfiguration | 
...
begin
  result = api_instance.create_external_admission_hook_configuration(body, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Exception when calling AdmissionregistrationV1alpha1Api->create_external_admission_hook_configuration: #{e}"
end
```
...
> V1Status delete_collection_external_admission_hook_configuration(opts)
...
begin
  result = api_instance.delete_collection_external_admission_hook_configuration(opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Exception when calling AdmissionregistrationV1alpha1Api->delete_collection_external_admission_hook_configuration: #{e}"
end
```
...
> V1Status delete_external_admission_hook_configuration(name, body, opts)
...
begin
  result = api_instance.delete_external_admission_hook_configuration(name, body, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Exception when calling AdmissionregistrationV1alpha1Api->delete_external_admission_hook_configuration: #{e}"
end
```
...
> V1Status delete_initializer_configuration(name, body, opts)
...
begin
  result = api_instance.delete_initializer_configuration(name, body, opts)
  p result
rescue Kubernetes::ApiError => e
...
> V1alpha1ExternalAdmissionHookConfigurationList list_external_admission_hook_configuration(opts)
...
begin
  result = api_instance.list_external_admission_hook_configuration(opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Exception when calling AdmissionregistrationV1alpha1Api->list_external_admission_hook_configuration: #{e}"
end
```
...
> V1alpha1ExternalAdmissionHookConfiguration patch_external_admission_hook_configuration(name, body, opts)
...
begin
  result = api_instance.patch_external_admission_hook_configuration(name, body, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Exception when calling AdmissionregistrationV1alpha1Api->patch_external_admission_hook_configuration: #{e}"
end
```
...
> V1alpha1ExternalAdmissionHookConfiguration read_external_admission_hook_configuration(name, , opts)
...
begin
  result = api_instance.read_external_admission_hook_configuration(name, , opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Exception when calling AdmissionregistrationV1alpha1Api->read_external_admission_hook_configuration: #{e}"
end
```
...
> V1alpha1ExternalAdmissionHookConfiguration replace_external_admission_hook_configuration(name, body, opts)
...
begin
  result = api_instance.replace_external_admission_hook_configuration(name, body, opts)
  p result
rescue Kubernetes::ApiError => e
  puts "Exception when calling AdmissionregistrationV1alpha1Api->replace_external_admission_hook_configuration: #{e}"
end
```
