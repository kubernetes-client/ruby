...
begin
  ...
  puts "Exception when calling CoordinationV1Api->create_namespaced_lease: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->delete_collection_namespaced_lease: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->delete_namespaced_lease: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->get_api_resources: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->list_lease_for_all_namespaces: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->list_namespaced_lease: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->patch_namespaced_lease: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->read_namespaced_lease: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CoordinationV1Api->replace_namespaced_lease: #{e}"
end
```
