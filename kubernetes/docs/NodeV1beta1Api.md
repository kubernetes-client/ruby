...
> V1beta1RuntimeClass create_runtime_class(body, opts)
...
body = Kubernetes::V1beta1RuntimeClass.new # V1beta1RuntimeClass | 
opts = {
...
begin
  ...
  puts "Exception when calling NodeV1beta1Api->create_runtime_class: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NodeV1beta1Api->delete_collection_runtime_class: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NodeV1beta1Api->delete_runtime_class: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NodeV1beta1Api->get_api_resources: #{e}"
end
```
...
> V1beta1RuntimeClassList list_runtime_class(opts)
...
begin
  ...
  puts "Exception when calling NodeV1beta1Api->list_runtime_class: #{e}"
end
```
...
> V1beta1RuntimeClass patch_runtime_class(name, body, opts)
...
begin
  ...
  puts "Exception when calling NodeV1beta1Api->patch_runtime_class: #{e}"
end
```
...
> V1beta1RuntimeClass read_runtime_class(name, opts)
...
begin
  ...
  puts "Exception when calling NodeV1beta1Api->read_runtime_class: #{e}"
end
```
...
> V1beta1RuntimeClass replace_runtime_class(name, body, opts)
...
begin
  ...
  puts "Exception when calling NodeV1beta1Api->replace_runtime_class: #{e}"
end
```
