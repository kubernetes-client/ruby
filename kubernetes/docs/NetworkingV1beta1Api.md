...
> NetworkingV1beta1Ingress create_namespaced_ingress(namespace, body, opts)
...
body = Kubernetes::NetworkingV1beta1Ingress.new # NetworkingV1beta1Ingress | 
opts = {
...
begin
  ...
  puts "Exception when calling NetworkingV1beta1Api->create_namespaced_ingress: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NetworkingV1beta1Api->delete_collection_namespaced_ingress: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NetworkingV1beta1Api->delete_namespaced_ingress: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling NetworkingV1beta1Api->get_api_resources: #{e}"
end
```
...
> NetworkingV1beta1IngressList list_ingress_for_all_namespaces(opts)
...
begin
  ...
  puts "Exception when calling NetworkingV1beta1Api->list_ingress_for_all_namespaces: #{e}"
end
```
...
> NetworkingV1beta1IngressList list_namespaced_ingress(namespace, opts)
...
begin
  ...
  puts "Exception when calling NetworkingV1beta1Api->list_namespaced_ingress: #{e}"
end
```
...
> NetworkingV1beta1Ingress patch_namespaced_ingress(name, namespace, body, opts)
...
begin
  ...
  puts "Exception when calling NetworkingV1beta1Api->patch_namespaced_ingress: #{e}"
end
```
...
> NetworkingV1beta1Ingress patch_namespaced_ingress_status(name, namespace, body, opts)
...
begin
  ...
  puts "Exception when calling NetworkingV1beta1Api->patch_namespaced_ingress_status: #{e}"
end
```
...
> NetworkingV1beta1Ingress read_namespaced_ingress(name, namespace, opts)
...
begin
  ...
  puts "Exception when calling NetworkingV1beta1Api->read_namespaced_ingress: #{e}"
end
```
...
> NetworkingV1beta1Ingress read_namespaced_ingress_status(name, namespace, opts)
...
begin
  ...
  puts "Exception when calling NetworkingV1beta1Api->read_namespaced_ingress_status: #{e}"
end
```
...
> NetworkingV1beta1Ingress replace_namespaced_ingress(name, namespace, body, opts)
...
begin
  ...
  puts "Exception when calling NetworkingV1beta1Api->replace_namespaced_ingress: #{e}"
end
```
...
> NetworkingV1beta1Ingress replace_namespaced_ingress_status(name, namespace, body, opts)
...
begin
  ...
  puts "Exception when calling NetworkingV1beta1Api->replace_namespaced_ingress_status: #{e}"
end
```
