...
body = Kubernetes::V1VolumeAttachment.new # V1VolumeAttachment | 
...
begin
  ...
  puts "Exception when calling StorageV1Api->create_volume_attachment: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling StorageV1Api->delete_collection_volume_attachment: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling StorageV1Api->delete_volume_attachment: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling StorageV1Api->list_volume_attachment: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling StorageV1Api->patch_volume_attachment: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling StorageV1Api->patch_volume_attachment_status: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling StorageV1Api->read_volume_attachment: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling StorageV1Api->read_volume_attachment_status: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling StorageV1Api->replace_volume_attachment: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling StorageV1Api->replace_volume_attachment_status: #{e}"
end
```
