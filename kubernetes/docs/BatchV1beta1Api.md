...
begin
  ...
  puts "Exception when calling BatchV1beta1Api->delete_collection_namespaced_cron_job: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1beta1Api->delete_namespaced_cron_job: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1beta1Api->get_api_resources: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1beta1Api->list_cron_job_for_all_namespaces: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1beta1Api->list_namespaced_cron_job: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1beta1Api->patch_namespaced_cron_job: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1beta1Api->patch_namespaced_cron_job_status: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1beta1Api->read_namespaced_cron_job: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1beta1Api->read_namespaced_cron_job_status: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1beta1Api->replace_namespaced_cron_job: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling BatchV1beta1Api->replace_namespaced_cron_job_status: #{e}"
end
```
