...
begin
  ...
  puts "Exception when calling CertificatesV1beta1Api->patch_certificate_signing_request_status: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling CertificatesV1beta1Api->read_certificate_signing_request_status: #{e}"
end
```
