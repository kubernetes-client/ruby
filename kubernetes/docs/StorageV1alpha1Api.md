...
body = Kubernetes::V1alpha1VolumeAttachment.new # V1alpha1VolumeAttachment | 
...
begin
  ...
  puts "Exception when calling StorageV1alpha1Api->create_volume_attachment: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling StorageV1alpha1Api->delete_collection_volume_attachment: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling StorageV1alpha1Api->delete_volume_attachment: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling StorageV1alpha1Api->get_api_resources: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling StorageV1alpha1Api->list_volume_attachment: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling StorageV1alpha1Api->patch_volume_attachment: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling StorageV1alpha1Api->read_volume_attachment: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling StorageV1alpha1Api->replace_volume_attachment: #{e}"
end
```
