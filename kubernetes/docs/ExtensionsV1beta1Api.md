...
> ExtensionsV1beta1DeploymentRollback create_namespaced_deployment_rollback(name, namespace, body, opts)
...
> V1beta1PodSecurityPolicy create_pod_security_policy(body, opts)
...
body = Kubernetes::V1beta1PodSecurityPolicy.new # V1beta1PodSecurityPolicy | 
...
> V1Status delete_namespaced_network_policy(name, namespace, body, opts)
...
begin
  result = api_instance.delete_namespaced_network_policy(name, namespace, body, opts)
  p result
rescue Kubernetes::ApiError => e
...
> V1Status delete_pod_security_policy(name, body, opts)
...
begin
  result = api_instance.delete_pod_security_policy(name, body, opts)
  p result
rescue Kubernetes::ApiError => e
...
> V1beta1PodSecurityPolicyList list_pod_security_policy(opts)
...
> V1beta1PodSecurityPolicy patch_pod_security_policy(name, body, opts)
...
> V1beta1PodSecurityPolicy read_pod_security_policy(name, , opts)
...
> V1beta1PodSecurityPolicy replace_pod_security_policy(name, body, opts)
