...
module Kubernetes
  class StorageV1beta1Api
    ...
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
    # @return [Array<(V1beta1CSIDriver, Integer, Hash)>] V1beta1CSIDriver data, response status code and response headers
    def create_csi_driver_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.create_csi_driver ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling StorageV1beta1Api.create_csi_driver"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1CSIDriver' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#create_csi_driver\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end

    # create a CSINode
    # @param body [V1beta1CSINode] 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
    ...
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
    # @return [Array<(V1beta1CSINode, Integer, Hash)>] V1beta1CSINode data, response status code and response headers
    def create_csi_node_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.create_csi_node ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling StorageV1beta1Api.create_csi_node"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1CSINode' 
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#create_csi_node\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_storage_class_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1StorageClass' 
    ...
    def create_volume_attachment_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1VolumeAttachment' 
    ...
    def delete_collection_csi_driver_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.delete_collection_csi_driver ...'
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/csidrivers'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#delete_collection_csi_driver\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_collection_csi_node_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.delete_collection_csi_node ...'
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/csinodes'
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#delete_collection_csi_node\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_csi_driver_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.delete_csi_driver ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling StorageV1beta1Api.delete_csi_driver"
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/csidrivers/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#delete_csi_driver\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_csi_node_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.delete_csi_node ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling StorageV1beta1Api.delete_csi_node"
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/csinodes/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#delete_csi_node\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_storage_class_with_http_info(name, opts = {})
      ...
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/storageclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
    ...
    def delete_volume_attachment_with_http_info(name, opts = {})
      ...
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/volumeattachments/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
    ...
    # @option opts [Integer] :timeout_seconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(V1beta1CSIDriverList, Integer, Hash)>] V1beta1CSIDriverList data, response status code and response headers
    def list_csi_driver_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.list_csi_driver ...'
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/csidrivers'
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1CSIDriverList' 
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#list_csi_driver\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Integer] :timeout_seconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(V1beta1CSINodeList, Integer, Hash)>] V1beta1CSINodeList data, response status code and response headers
    def list_csi_node_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.list_csi_node ...'
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/csinodes'
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1CSINodeList' 
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#list_csi_node\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_storage_class_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1StorageClassList' 
    ...
    def list_volume_attachment_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1VolumeAttachmentList' 
    ...
    def patch_csi_driver_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.patch_csi_driver ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling StorageV1beta1Api.patch_csi_driver"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling StorageV1beta1Api.patch_csi_driver"
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/csidrivers/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#patch_csi_driver\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def patch_csi_node_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.patch_csi_node ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling StorageV1beta1Api.patch_csi_node"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling StorageV1beta1Api.patch_csi_node"
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/csinodes/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#patch_csi_node\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def read_csi_driver_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.read_csi_driver ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling StorageV1beta1Api.read_csi_driver"
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/csidrivers/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#read_csi_driver\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def read_csi_node_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.read_csi_node ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling StorageV1beta1Api.read_csi_node"
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/csinodes/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#read_csi_node\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def replace_csi_driver_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.replace_csi_driver ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling StorageV1beta1Api.replace_csi_driver"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling StorageV1beta1Api.replace_csi_driver"
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/csidrivers/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#replace_csi_driver\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def replace_csi_node_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageV1beta1Api.replace_csi_node ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling StorageV1beta1Api.replace_csi_node"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling StorageV1beta1Api.replace_csi_node"
      end
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1beta1/csinodes/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StorageV1beta1Api#replace_csi_node\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
