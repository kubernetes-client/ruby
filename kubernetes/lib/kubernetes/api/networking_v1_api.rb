...
module Kubernetes
  class NetworkingV1Api
    ...
    def create_namespaced_network_policy_with_http_info(namespace, body, opts = {})
      ...
      # resource path
      local_var_path = '/apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s).gsub('%2F', '/'))
      ...
      # return_type
      return_type = opts[:return_type] || 'V1NetworkPolicy' 
    ...
    def delete_namespaced_network_policy_with_http_info(name, namespace, opts = {})
      ...
      # resource path
      local_var_path = '/apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/')).sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s).gsub('%2F', '/'))
    ...
    def list_namespaced_network_policy_with_http_info(namespace, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1NetworkPolicyList' 
