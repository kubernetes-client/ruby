...
module Kubernetes
  class AutoscalingV1Api
    ...
    def create_namespaced_horizontal_pod_autoscaler_with_http_info(namespace, body, opts = {})
      ...
      # resource path
      local_var_path = '/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s).gsub('%2F', '/'))
      ...
      # return_type
      return_type = opts[:return_type] || 'V1HorizontalPodAutoscaler' 
    ...
    def delete_namespaced_horizontal_pod_autoscaler_with_http_info(name, namespace, opts = {})
      ...
      # resource path
      local_var_path = '/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/')).sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s).gsub('%2F', '/'))
    ...
    def list_horizontal_pod_autoscaler_for_all_namespaces_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1HorizontalPodAutoscalerList' 
    ...
    def patch_namespaced_horizontal_pod_autoscaler_status_with_http_info(name, namespace, body, opts = {})
      ...
      # resource path
      local_var_path = '/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/')).sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s).gsub('%2F', '/'))
