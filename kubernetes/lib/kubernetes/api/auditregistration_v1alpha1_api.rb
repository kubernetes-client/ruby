...
module Kubernetes
  class AuditregistrationV1alpha1Api
    ...
    def create_audit_sink_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1alpha1AuditSink' 
    ...
    def delete_audit_sink_with_http_info(name, opts = {})
      ...
      # resource path
      local_var_path = '/apis/auditregistration.k8s.io/v1alpha1/auditsinks/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
    ...
    def list_audit_sink_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1alpha1AuditSinkList' 
