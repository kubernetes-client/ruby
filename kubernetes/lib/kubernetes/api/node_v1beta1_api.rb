...
module Kubernetes
  class NodeV1beta1Api
    ...
    # @param body [V1beta1RuntimeClass] 
    ...
    # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
    # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
    # @return [Array<(V1beta1RuntimeClass, Integer, Hash)>] V1beta1RuntimeClass data, response status code and response headers
    def create_runtime_class_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1beta1Api.create_runtime_class ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling NodeV1beta1Api.create_runtime_class"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1RuntimeClass' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1beta1Api#create_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_collection_runtime_class_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1beta1Api.delete_collection_runtime_class ...'
      end
      # resource path
      local_var_path = '/apis/node.k8s.io/v1beta1/runtimeclasses'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1beta1Api#delete_collection_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_runtime_class_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1beta1Api.delete_runtime_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling NodeV1beta1Api.delete_runtime_class"
      end
      # resource path
      local_var_path = '/apis/node.k8s.io/v1beta1/runtimeclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1beta1Api#delete_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_api_resources_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1beta1Api.get_api_resources ...'
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1beta1Api#get_api_resources\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Integer] :timeout_seconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(V1beta1RuntimeClassList, Integer, Hash)>] V1beta1RuntimeClassList data, response status code and response headers
    def list_runtime_class_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1beta1Api.list_runtime_class ...'
      end
      # resource path
      local_var_path = '/apis/node.k8s.io/v1beta1/runtimeclasses'
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1RuntimeClassList' 
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1beta1Api#list_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def patch_runtime_class_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1beta1Api.patch_runtime_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling NodeV1beta1Api.patch_runtime_class"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling NodeV1beta1Api.patch_runtime_class"
      end
      # resource path
      local_var_path = '/apis/node.k8s.io/v1beta1/runtimeclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1beta1Api#patch_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def read_runtime_class_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1beta1Api.read_runtime_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling NodeV1beta1Api.read_runtime_class"
      end
      # resource path
      local_var_path = '/apis/node.k8s.io/v1beta1/runtimeclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1beta1Api#read_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def replace_runtime_class_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1beta1Api.replace_runtime_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling NodeV1beta1Api.replace_runtime_class"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling NodeV1beta1Api.replace_runtime_class"
      end
      # resource path
      local_var_path = '/apis/node.k8s.io/v1beta1/runtimeclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1beta1Api#replace_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
