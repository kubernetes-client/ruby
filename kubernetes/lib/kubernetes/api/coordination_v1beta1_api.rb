...
module Kubernetes
  class CoordinationV1beta1Api
    ...
    def create_namespaced_lease_with_http_info(namespace, body, opts = {})
      ...
      # resource path
      local_var_path = '/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s).gsub('%2F', '/'))
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1Lease' 
    ...
    def delete_namespaced_lease_with_http_info(name, namespace, opts = {})
      ...
      # resource path
      local_var_path = '/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/')).sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s).gsub('%2F', '/'))
    ...
    def list_lease_for_all_namespaces_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1LeaseList' 
