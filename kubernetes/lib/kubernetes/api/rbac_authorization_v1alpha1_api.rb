...
module Kubernetes
  class RbacAuthorizationV1alpha1Api
    ...
    def create_cluster_role_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1alpha1ClusterRole' 
    ...
    def create_cluster_role_binding_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1alpha1ClusterRoleBinding' 
    ...
    def create_namespaced_role_with_http_info(namespace, body, opts = {})
      ...
      # resource path
      local_var_path = '/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s).gsub('%2F', '/'))
      ...
      # return_type
      return_type = opts[:return_type] || 'V1alpha1Role' 
    ...
    def create_namespaced_role_binding_with_http_info(namespace, body, opts = {})
      ...
      # resource path
      local_var_path = '/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s).gsub('%2F', '/'))
      ...
      # return_type
      return_type = opts[:return_type] || 'V1alpha1RoleBinding' 
    ...
    def delete_cluster_role_with_http_info(name, opts = {})
      ...
      # resource path
      local_var_path = '/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
    ...
    def delete_cluster_role_binding_with_http_info(name, opts = {})
      ...
      # resource path
      local_var_path = '/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
    ...
    def delete_namespaced_role_with_http_info(name, namespace, opts = {})
      ...
      # resource path
      local_var_path = '/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/')).sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s).gsub('%2F', '/'))
    ...
    def delete_namespaced_role_binding_with_http_info(name, namespace, opts = {})
      ...
      # resource path
      local_var_path = '/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/')).sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s).gsub('%2F', '/'))
    ...
    def list_cluster_role_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1alpha1ClusterRoleList' 
    ...
    def list_cluster_role_binding_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1alpha1ClusterRoleBindingList' 
    ...
    def list_namespaced_role_with_http_info(namespace, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1alpha1RoleList' 
    ...
    def list_namespaced_role_binding_with_http_info(namespace, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1alpha1RoleBindingList' 
