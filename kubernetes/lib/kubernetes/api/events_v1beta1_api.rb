...
module Kubernetes
  class EventsV1beta1Api
    ...
    def create_namespaced_event_with_http_info(namespace, body, opts = {})
      ...
      # resource path
      local_var_path = '/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s).gsub('%2F', '/'))
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1Event' 
    ...
    def delete_namespaced_event_with_http_info(name, namespace, opts = {})
      ...
      # resource path
      local_var_path = '/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/')).sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s).gsub('%2F', '/'))
    ...
    def list_event_for_all_namespaces_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1EventList' 
