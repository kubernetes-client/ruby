...
module Kubernetes
  class SchedulingV1alpha1Api
    ...
    def create_priority_class_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1alpha1PriorityClass' 
    ...
    def delete_priority_class_with_http_info(name, opts = {})
      ...
      # resource path
      local_var_path = '/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
    ...
    def list_priority_class_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1alpha1PriorityClassList' 
