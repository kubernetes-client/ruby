...
module Kubernetes
  class SchedulingV1alpha1Api
    ...
    # @return [V1Status]
    def delete_priority_class(name, body, opts = {})
      data, _status_code, _headers = delete_priority_class_with_http_info(name, body, opts)
      return data
    end
    ...
    # @option opts [String] :propagation_policy Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy.
    # @return [Array<(V1Status, Fixnum, Hash)>] V1Status data, response status code and response headers
    def delete_priority_class_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling SchedulingV1alpha1Api.delete_priority_class"
      end
      # resource path
