...
module Kubernetes
  class ApiregistrationV1beta1Api
    ...
    def create_api_service_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1APIService' 
    ...
    def delete_api_service_with_http_info(name, opts = {})
      ...
      # resource path
      local_var_path = '/apis/apiregistration.k8s.io/v1beta1/apiservices/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
    ...
    def list_api_service_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1APIServiceList' 
    ...
    def patch_api_service_status_with_http_info(name, body, opts = {})
      ...
      # resource path
      local_var_path = '/apis/apiregistration.k8s.io/v1beta1/apiservices/{name}/status'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
