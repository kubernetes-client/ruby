...
module Kubernetes
  class ApiregistrationV1beta1Api
    ...
    # @return [V1Status]
    def delete_api_service(name, body, opts = {})
      data, _status_code, _headers = delete_api_service_with_http_info(name, body, opts)
      return data
    end
    ...
    def delete_api_service_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ApiregistrationV1beta1Api.delete_api_service"
      end
      # resource path
