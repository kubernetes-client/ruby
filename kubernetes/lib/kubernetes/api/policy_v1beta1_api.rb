...
module Kubernetes
  class PolicyV1beta1Api
    ...
    def create_namespaced_pod_disruption_budget_with_http_info(namespace, body, opts = {})
      ...
      # resource path
      local_var_path = '/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s).gsub('%2F', '/'))
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1PodDisruptionBudget' 
    ...
    def create_pod_security_policy_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'PolicyV1beta1PodSecurityPolicy' 
    ...
    def delete_namespaced_pod_disruption_budget_with_http_info(name, namespace, opts = {})
      ...
      # resource path
      local_var_path = '/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/')).sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s).gsub('%2F', '/'))
    ...
    def delete_pod_security_policy_with_http_info(name, opts = {})
      ...
      # resource path
      local_var_path = '/apis/policy/v1beta1/podsecuritypolicies/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
    ...
    def list_namespaced_pod_disruption_budget_with_http_info(namespace, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1PodDisruptionBudgetList' 
    ...
    def list_pod_security_policy_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'PolicyV1beta1PodSecurityPolicyList' 
    ...
    def patch_namespaced_pod_disruption_budget_status_with_http_info(name, namespace, body, opts = {})
      ...
      # resource path
      local_var_path = '/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}/status'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/')).sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s).gsub('%2F', '/'))
