...
module Kubernetes
  class StorageV1alpha1Api
    ...
    def create_volume_attachment_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1alpha1VolumeAttachment' 
    ...
    def delete_volume_attachment_with_http_info(name, opts = {})
      ...
      # resource path
      local_var_path = '/apis/storage.k8s.io/v1alpha1/volumeattachments/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
    ...
    def list_volume_attachment_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1alpha1VolumeAttachmentList' 
