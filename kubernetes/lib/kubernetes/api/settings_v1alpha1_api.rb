...
module Kubernetes
  class SettingsV1alpha1Api
    ...
    def create_namespaced_pod_preset_with_http_info(namespace, body, opts = {})
      ...
      # resource path
      local_var_path = '/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets'.sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s).gsub('%2F', '/'))
      ...
      # return_type
      return_type = opts[:return_type] || 'V1alpha1PodPreset' 
    ...
    def delete_namespaced_pod_preset_with_http_info(name, namespace, opts = {})
      ...
      # resource path
      local_var_path = '/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/')).sub('{' + 'namespace' + '}', CGI.escape(namespace.to_s).gsub('%2F', '/'))
    ...
    def list_namespaced_pod_preset_with_http_info(namespace, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1alpha1PodPresetList' 
