...
module Kubernetes
  class AdmissionregistrationV1beta1Api
    ...
    def create_mutating_webhook_configuration_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1MutatingWebhookConfiguration' 
    ...
    def create_validating_webhook_configuration_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1ValidatingWebhookConfiguration' 
    ...
    def delete_mutating_webhook_configuration_with_http_info(name, opts = {})
      ...
      # resource path
      local_var_path = '/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
    ...
    def delete_validating_webhook_configuration_with_http_info(name, opts = {})
      ...
      # resource path
      local_var_path = '/apis/admissionregistration.k8s.io/v1beta1/validatingwebhookconfigurations/{name}'.sub('{' + 'name' + '}', CGI.escape(name.to_s).gsub('%2F', '/'))
    ...
    def list_mutating_webhook_configuration_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1MutatingWebhookConfigurationList' 
    ...
    def list_validating_webhook_configuration_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'V1beta1ValidatingWebhookConfigurationList' 
