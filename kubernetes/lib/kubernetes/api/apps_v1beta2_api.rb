...
module Kubernetes
  class AppsV1beta2Api
    ...
    def delete_namespaced_controller_revision_with_http_info(name, namespace, body, opts = {})
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling AppsV1beta2Api.delete_namespaced_controller_revision"
      end
      # resource path
    ...
    def delete_namespaced_daemon_set_with_http_info(name, namespace, body, opts = {})
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling AppsV1beta2Api.delete_namespaced_daemon_set"
      end
      # resource path
    ...
    def delete_namespaced_deployment_with_http_info(name, namespace, body, opts = {})
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling AppsV1beta2Api.delete_namespaced_deployment"
      end
      # resource path
    ...
    def delete_namespaced_replica_set_with_http_info(name, namespace, body, opts = {})
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling AppsV1beta2Api.delete_namespaced_replica_set"
      end
      # resource path
    ...
    def delete_namespaced_stateful_set_with_http_info(name, namespace, body, opts = {})
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling AppsV1beta2Api.delete_namespaced_stateful_set"
      end
      # resource path
