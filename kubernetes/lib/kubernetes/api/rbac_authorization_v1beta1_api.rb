...
module Kubernetes
  class RbacAuthorizationV1beta1Api
    ...
    def delete_cluster_role_with_http_info(name, body, opts = {})
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling RbacAuthorizationV1beta1Api.delete_cluster_role"
      end
      # resource path
    ...
    def delete_cluster_role_binding_with_http_info(name, body, opts = {})
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling RbacAuthorizationV1beta1Api.delete_cluster_role_binding"
      end
      # resource path
    ...
    def delete_namespaced_role_with_http_info(name, namespace, body, opts = {})
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling RbacAuthorizationV1beta1Api.delete_namespaced_role"
      end
      # resource path
    ...
    def delete_namespaced_role_binding_with_http_info(name, namespace, body, opts = {})
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling RbacAuthorizationV1beta1Api.delete_namespaced_role_binding"
      end
      # resource path
