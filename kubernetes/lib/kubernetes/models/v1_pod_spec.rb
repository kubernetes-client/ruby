...
module Kubernetes
  ...
  class V1PodSpec
    ...
    def hash
      [active_deadline_seconds, affinity, automount_service_account_token, containers, dns_policy, host_aliases, host_ipc, host_network, host_pid, hostname, image_pull_secrets, init_containers, node_name, node_selector, priority, priority_class_name, restart_policy, scheduler_name, security_context, service_account, service_account_name, subdomain, termination_grace_period_seconds, tolerations, volumes].hash
    end
