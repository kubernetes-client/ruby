...
module Kubernetes
  ...
  class V1APIGroup
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'preferredVersion')
        self.preferred_version = attributes[:'preferredVersion']
      end

      if attributes.has_key?(:'serverAddressByClientCIDRs')
        if (value = attributes[:'serverAddressByClientCIDRs']).is_a?(Array)
