...
module Kubernetes
  ...
  class V2beta1HorizontalPodAutoscalerStatus
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'currentMetrics')
        if (value = attributes[:'currentMetrics']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @current_metrics.nil?
        invalid_properties.push("invalid value for 'current_metrics', current_metrics cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @current_metrics.nil?
