...
module Kubernetes
  ...
  class V1beta1Event
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'deprecatedCount')
        self.deprecated_count = attributes[:'deprecatedCount']
      end

      if attributes.has_key?(:'deprecatedFirstTimestamp')
        self.deprecated_first_timestamp = attributes[:'deprecatedFirstTimestamp']
      end

      if attributes.has_key?(:'deprecatedLastTimestamp')
        self.deprecated_last_timestamp = attributes[:'deprecatedLastTimestamp']
      end

      if attributes.has_key?(:'deprecatedSource')
        self.deprecated_source = attributes[:'deprecatedSource']
      end
      ...
      if attributes.has_key?(:'regarding')
      ...
      if attributes.has_key?(:'reportingController')
