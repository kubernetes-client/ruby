...
module Kubernetes
  ...
  class ExtensionsV1beta1DeploymentSpec
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'minReadySeconds')
        self.min_ready_seconds = attributes[:'minReadySeconds']
      end
      ...
      if attributes.has_key?(:'progressDeadlineSeconds')
      ...
      if attributes.has_key?(:'rollbackTo')
        self.rollback_to = attributes[:'rollbackTo']
      end
