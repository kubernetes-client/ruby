...
module Kubernetes
  ...
  class V1CSIPersistentVolumeSource
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'controllerPublishSecretRef')
      ...
      if attributes.has_key?(:'nodeStageSecretRef')
      ...
      if attributes.has_key?(:'volumeAttributes')
        if (value = attributes[:'volumeAttributes']).is_a?(Array)
          self.volume_attributes = value
        end
      end

      if attributes.has_key?(:'volumeHandle')
