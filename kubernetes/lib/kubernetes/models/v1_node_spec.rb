...
module Kubernetes
  ...
  class V1NodeSpec
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'configSource')
      ...
      if attributes.has_key?(:'podCIDR')
        self.pod_cidr = attributes[:'podCIDR']
      end
      ...
      if attributes.has_key?(:'taints')
        if (value = attributes[:'taints']).is_a?(Array)
          self.taints = value
        end
      end

      if attributes.has_key?(:'unschedulable')
