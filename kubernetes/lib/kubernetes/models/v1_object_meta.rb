...
module Kubernetes
  ...
  class V1ObjectMeta
    ...
    def hash
      [annotations, cluster_name, creation_timestamp, deletion_grace_period_seconds, deletion_timestamp, finalizers, generate_name, generation, initializers, labels, managed_fields, name, namespace, owner_references, resource_version, self_link, uid].hash
    end
