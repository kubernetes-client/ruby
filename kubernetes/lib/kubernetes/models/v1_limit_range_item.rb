...
module Kubernetes
  ...
  class V1LimitRangeItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'defaultRequest')
        if (value = attributes[:'defaultRequest']).is_a?(Array)
          self.default_request = value
        end
      end

      if attributes.has_key?(:'max')
        if (value = attributes[:'max']).is_a?(Array)
          self.max = value
        end
      end

      if attributes.has_key?(:'maxLimitRequestRatio')
        if (value = attributes[:'maxLimitRequestRatio']).is_a?(Array)
          self.max_limit_request_ratio = value
        end
      end

      if attributes.has_key?(:'min')
        if (value = attributes[:'min']).is_a?(Array)
          self.min = value
        end
      end
