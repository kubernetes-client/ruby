...
# Unit tests for Kubernetes::StorageV1alpha1Api
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StorageV1alpha1Api' do
  before do
    # run before each test
    @instance = Kubernetes::StorageV1alpha1Api.new
  end
  ...
  describe 'test an instance of StorageV1alpha1Api' do
    it 'should create an instance of StorageV1alpha1Api' do
      expect(@instance).to be_instance_of(Kubernetes::StorageV1alpha1Api)
    end
  end
