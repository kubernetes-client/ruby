...
# Unit tests for Kubernetes::AuditregistrationV1alpha1Api
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuditregistrationV1alpha1Api' do
  before do
    # run before each test
    @instance = Kubernetes::AuditregistrationV1alpha1Api.new
  end
  ...
  describe 'test an instance of AuditregistrationV1alpha1Api' do
    it 'should create an instance of AuditregistrationV1alpha1Api' do
      expect(@instance).to be_instance_of(Kubernetes::AuditregistrationV1alpha1Api)
    end
  end

  # unit tests for create_audit_sink
  # 
  # create an AuditSink
  # @param body 
  ...
  describe 'create_audit_sink test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_audit_sink
  # 
  # delete an AuditSink
  ...
  # @return [V1Status]
  describe 'delete_audit_sink test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_collection_audit_sink
  # 
  ...
  # @return [V1Status]
  describe 'delete_collection_audit_sink test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for list_audit_sink
  # 
  ...
  describe 'list_audit_sink test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_audit_sink
  # 
  ...
  # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
  # @return [V1alpha1AuditSink]
  describe 'patch_audit_sink test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_audit_sink
  # 
  ...
  # @return [V1alpha1AuditSink]
  describe 'read_audit_sink test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_audit_sink
  # 
  ...
  # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
  # @return [V1alpha1AuditSink]
  describe 'replace_audit_sink test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
