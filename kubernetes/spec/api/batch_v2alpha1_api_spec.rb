...
# Unit tests for Kubernetes::BatchV2alpha1Api
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BatchV2alpha1Api' do
  before do
    # run before each test
    @instance = Kubernetes::BatchV2alpha1Api.new
  end
  ...
  describe 'test an instance of BatchV2alpha1Api' do
    it 'should create an instance of BatchV2alpha1Api' do
      expect(@instance).to be_instance_of(Kubernetes::BatchV2alpha1Api)
    end
  end

  # unit tests for create_namespaced_cron_job
  # 
  # create a CronJob
  ...
  describe 'create_namespaced_cron_job test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_collection_namespaced_cron_job
  # 
  ...
  # @return [V1Status]
  describe 'delete_collection_namespaced_cron_job test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_namespaced_cron_job
  # 
  # delete a CronJob
  ...
  # @return [V1Status]
  describe 'delete_namespaced_cron_job test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for list_cron_job_for_all_namespaces
  # 
  ...
  describe 'list_cron_job_for_all_namespaces test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_namespaced_cron_job
  # 
  # list or watch objects of kind CronJob
  # @param namespace object name and auth scope, such as for teams and projects
  # @param [Hash] opts the optional parameters
  ...
  # @option opts [BOOLEAN] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
  # @return [V2alpha1CronJobList]
  describe 'list_namespaced_cron_job test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_namespaced_cron_job
  # 
  ...
  # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
  # @return [V2alpha1CronJob]
  describe 'patch_namespaced_cron_job test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_namespaced_cron_job_status
  # 
  ...
  # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
  # @return [V2alpha1CronJob]
  describe 'patch_namespaced_cron_job_status test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_namespaced_cron_job
  # 
  ...
  # @return [V2alpha1CronJob]
  describe 'read_namespaced_cron_job test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_namespaced_cron_job_status
  # 
  ...
  # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
  # @return [V2alpha1CronJob]
  describe 'read_namespaced_cron_job_status test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_namespaced_cron_job
  # 
  ...
  # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
  # @return [V2alpha1CronJob]
  describe 'replace_namespaced_cron_job test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_namespaced_cron_job_status
  # 
  ...
  # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
  # @return [V2alpha1CronJob]
  describe 'replace_namespaced_cron_job_status test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
