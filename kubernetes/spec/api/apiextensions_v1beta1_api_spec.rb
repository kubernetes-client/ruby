...
describe 'ApiextensionsV1beta1Api' do
  before do
    ...
    @instance = Kubernetes::ApiextensionsV1beta1Api.new
  end
  ...
  describe 'test an instance of ApiextensionsV1beta1Api' do
    it 'should create an instance of ApiextensionsV1beta1Api' do
      expect(@instance).to be_instance_of(Kubernetes::ApiextensionsV1beta1Api)
    end
  end

  # unit tests for create_custom_resource_definition
  # 
  ...
  describe 'create_custom_resource_definition test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_collection_custom_resource_definition
  # 
  ...
  # @return [V1Status]
  describe 'delete_collection_custom_resource_definition test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_custom_resource_definition
  # 
  ...
  # @return [V1Status]
  describe 'delete_custom_resource_definition test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for list_custom_resource_definition
  # 
  ...
  describe 'list_custom_resource_definition test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_custom_resource_definition
  # 
  ...
  # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
  # @return [V1beta1CustomResourceDefinition]
  describe 'patch_custom_resource_definition test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_custom_resource_definition_status
  # 
  ...
  # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
  # @return [V1beta1CustomResourceDefinition]
  describe 'patch_custom_resource_definition_status test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_custom_resource_definition
  # 
  ...
  # @return [V1beta1CustomResourceDefinition]
  describe 'read_custom_resource_definition test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_custom_resource_definition_status
  # 
  ...
  # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
  # @return [V1beta1CustomResourceDefinition]
  describe 'read_custom_resource_definition_status test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_custom_resource_definition
  # 
  ...
  # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
  # @return [V1beta1CustomResourceDefinition]
  describe 'replace_custom_resource_definition test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_custom_resource_definition_status
  # 
  ...
  # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
  # @return [V1beta1CustomResourceDefinition]
  describe 'replace_custom_resource_definition_status test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
