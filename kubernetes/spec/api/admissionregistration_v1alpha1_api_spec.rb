...
# Unit tests for Kubernetes::AdmissionregistrationV1alpha1Api
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AdmissionregistrationV1alpha1Api' do
  before do
    # run before each test
    @instance = Kubernetes::AdmissionregistrationV1alpha1Api.new
  end
  ...
  describe 'test an instance of AdmissionregistrationV1alpha1Api' do
    it 'should create an instance of AdmissionregistrationV1alpha1Api' do
      expect(@instance).to be_instance_of(Kubernetes::AdmissionregistrationV1alpha1Api)
    end
  end

  # unit tests for create_external_admission_hook_configuration
  # 
  ...
  describe 'create_external_admission_hook_configuration test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for create_initializer_configuration
  # 
  ...
  describe 'create_initializer_configuration test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_collection_external_admission_hook_configuration
  # 
  ...
  # @return [V1Status]
  describe 'delete_collection_external_admission_hook_configuration test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_collection_initializer_configuration
  # 
  ...
  # @option opts [BOOLEAN] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
  # @return [V1Status]
  describe 'delete_collection_initializer_configuration test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_external_admission_hook_configuration
  # 
  ...
  # @return [V1Status]
  describe 'delete_external_admission_hook_configuration test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_initializer_configuration
  # 
  ...
  # @option opts [String] :propagation_policy Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy.
  # @return [V1Status]
  describe 'delete_initializer_configuration test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for list_external_admission_hook_configuration
  # 
  ...
  describe 'list_external_admission_hook_configuration test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_initializer_configuration
  # 
  ...
  describe 'list_initializer_configuration test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_external_admission_hook_configuration
  # 
  ...
  # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
  # @return [V1alpha1ExternalAdmissionHookConfiguration]
  describe 'patch_external_admission_hook_configuration test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_initializer_configuration
  # 
  ...
  # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
  # @return [V1alpha1InitializerConfiguration]
  describe 'patch_initializer_configuration test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_external_admission_hook_configuration
  # 
  ...
  # @return [V1alpha1ExternalAdmissionHookConfiguration]
  describe 'read_external_admission_hook_configuration test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_initializer_configuration
  # 
  ...
  # @option opts [BOOLEAN] :export Should this value be exported.  Export strips fields that a user can not specify.
  # @return [V1alpha1InitializerConfiguration]
  describe 'read_initializer_configuration test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_external_admission_hook_configuration
  # 
  ...
  # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
  # @return [V1alpha1ExternalAdmissionHookConfiguration]
  describe 'replace_external_admission_hook_configuration test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_initializer_configuration
  # 
  ...
  # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
  # @return [V1alpha1InitializerConfiguration]
  describe 'replace_initializer_configuration test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
