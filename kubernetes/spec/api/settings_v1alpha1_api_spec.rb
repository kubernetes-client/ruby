...
# Unit tests for Kubernetes::SettingsV1alpha1Api
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SettingsV1alpha1Api' do
  before do
    # run before each test
    @instance = Kubernetes::SettingsV1alpha1Api.new
  end
  ...
  describe 'test an instance of SettingsV1alpha1Api' do
    it 'should create an instance of SettingsV1alpha1Api' do
      expect(@instance).to be_instance_of(Kubernetes::SettingsV1alpha1Api)
    end
  end

  # unit tests for create_namespaced_pod_preset
  # 
  # create a PodPreset
  ...
  describe 'create_namespaced_pod_preset test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_collection_namespaced_pod_preset
  # 
  ...
  # @return [V1Status]
  describe 'delete_collection_namespaced_pod_preset test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_namespaced_pod_preset
  # 
  # delete a PodPreset
  ...
  # @return [V1Status]
  describe 'delete_namespaced_pod_preset test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for list_namespaced_pod_preset
  # 
  ...
  describe 'list_namespaced_pod_preset test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_pod_preset_for_all_namespaces
  # 
  # list or watch objects of kind PodPreset
  # @param [Hash] opts the optional parameters
  # @option opts [String] :continue The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server the server will respond with a 410 ResourceExpired error indicating the client must restart their list without the continue field. This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
  ...
  # @option opts [BOOLEAN] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
  # @return [V1alpha1PodPresetList]
  describe 'list_pod_preset_for_all_namespaces test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_namespaced_pod_preset
  # 
  ...
  # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
  # @return [V1alpha1PodPreset]
  describe 'patch_namespaced_pod_preset test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_namespaced_pod_preset
  # 
  ...
  # @return [V1alpha1PodPreset]
  describe 'read_namespaced_pod_preset test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_namespaced_pod_preset
  # 
  ...
  # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
  # @return [V1alpha1PodPreset]
  describe 'replace_namespaced_pod_preset test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
