...
describe 'CoordinationV1beta1Api' do
  before do
    ...
    @instance = Kubernetes::CoordinationV1beta1Api.new
  end
  ...
  describe 'test an instance of CoordinationV1beta1Api' do
    it 'should create an instance of CoordinationV1beta1Api' do
      expect(@instance).to be_instance_of(Kubernetes::CoordinationV1beta1Api)
    end
  end

  # unit tests for create_namespaced_lease
  # 
  # create a Lease
  ...
  # @return [V1beta1Lease]
  describe 'create_namespaced_lease test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_collection_namespaced_lease
  # 
  ...
  # @return [V1Status]
  describe 'delete_collection_namespaced_lease test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_namespaced_lease
  # 
  # delete a Lease
  ...
  # @return [V1Status]
  describe 'delete_namespaced_lease test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for list_lease_for_all_namespaces
  # 
  ...
  describe 'list_lease_for_all_namespaces test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_namespaced_lease
  # 
  # list or watch objects of kind Lease
  # @param namespace object name and auth scope, such as for teams and projects
  # @param [Hash] opts the optional parameters
  ...
  # @option opts [BOOLEAN] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
  # @return [V1beta1LeaseList]
  describe 'list_namespaced_lease test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_namespaced_lease
  # 
  ...
  # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
  # @return [V1beta1Lease]
  describe 'patch_namespaced_lease test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_namespaced_lease
  # 
  ...
  # @return [V1beta1Lease]
  describe 'read_namespaced_lease test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_namespaced_lease
  # 
  ...
  # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
  # @return [V1beta1Lease]
  describe 'replace_namespaced_lease test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
