...
# Unit tests for Kubernetes::SchedulingV1alpha1Api
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SchedulingV1alpha1Api' do
  before do
    # run before each test
    @instance = Kubernetes::SchedulingV1alpha1Api.new
  end
  ...
  describe 'test an instance of SchedulingV1alpha1Api' do
    it 'should create an instance of SchedulingV1alpha1Api' do
      expect(@instance).to be_instance_of(Kubernetes::SchedulingV1alpha1Api)
    end
  end

  # unit tests for create_priority_class
  # 
  ...
  describe 'create_priority_class test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_collection_priority_class
  # 
  ...
  # @return [V1Status]
  describe 'delete_collection_priority_class test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_priority_class
  # 
  ...
  # @return [V1Status]
  describe 'delete_priority_class test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for list_priority_class
  # 
  ...
  describe 'list_priority_class test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_priority_class
  # 
  ...
  # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
  # @return [V1alpha1PriorityClass]
  describe 'patch_priority_class test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for read_priority_class
  # 
  ...
  # @return [V1alpha1PriorityClass]
  describe 'read_priority_class test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for replace_priority_class
  # 
  ...
  # @option opts [String] :dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
  # @return [V1alpha1PriorityClass]
  describe 'replace_priority_class test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
